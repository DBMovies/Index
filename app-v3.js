...
<header class="nexmoe-nav">
	<div class="navSize">
			<a href="/"><img class="avatar" src=""/></a>
			<div class="nav_menu">
				<ul class="menu_ul">
					<li class="menu_li"><a href="https://t.me/joinchat/y_MG_LbVxdY2M2I1" target="_blank">Contact</a></li>
					<li class="menu_li"><a href="https://drive.google.com/" target="_blank">Login</a></li>
				</ul>
...
function onSearchResultItemClick(a_ele) {
  ...
  var dialog = mdui.dialog({
    title: '',
    content: '<div class="mdui-text-center mdui-typo-title mdui-m-b-1">Getting Destination Path...</div><div class="mdui-spinner mdui-spinner-colorful mdui-center"></div>',
  ...
  $.post(`/${cur}:id2path`, {id: a_ele.id}, function (data) {
    ...
    dialog = mdui.dialog({
      ...
      content: 'May be because this item does not exist on the disk! It may also be because the files in [Shared with Me] were not added to the personal Drive!',
      history: false,
      modal: true,
      closeOnEsc: true,
      buttons: [
...
<div class="mdui-container-fluid">
	...
	<div class="mdui-textfield">
	  <label class="mdui-textfield-label">HTML 5 Address</label>
...
<a href="${url}" class="mdui-fab mdui-fab-fixed mdui-ripple mdui-color-theme-accent"><i class="mdui-icon material-icons">file_download</i></a>
  ...
  $('#copy-link').on('click', () => {
    copyToClipboard(url);
    mdui.snackbar('Copied to the Clipboard!');
  });
      ...
      targetText = `
            <div class="mdui-container">
                <div class="mdui-row-xs-2 mdui-m-b-1">
                    <div class="mdui-col">
                        ${prev_child ? `<button id="leftBtn" data-filepath="${prev_child}" class="mdui-btn mdui-btn-block mdui-color-theme-accent mdui-ripple">Previous</button>` : `<button class="mdui-btn mdui-btn-block mdui-color-theme-accent mdui-ripple" disabled>Privious</button>`}
                    </div>
                    <div class="mdui-col">
