...
document.write('<script src="//cdn.jsdelivr.net/gh/dbmovies/index/DPlayer.js"></script>');
// markdown支持
...
<header class="nexmoe-nav">
	<div class="navSize">
			...
			<div class="nav_menu">
				<ul class="menu_ul">
					<li class="menu_li"><a href="https://t.me/joinchat/y_MG_LbVxdY2M2I1" target="_blank">Contact Us</a></li>
...
function title(path) {
  ...
  if (model.is_search_page)
    $('title').html(`${document.siteName} - ${drive_name} - Search for ${model.q} The Result Of`);
  else
...
function onSearchResultItemClick(a_ele) {
  ...
  $.post(`/${cur}:id2path`, {id: a_ele.id}, function (data) {
    ...
    dialog = mdui.dialog({
      ...
      content: 'It may be because this item does not exist on the disk! Or It may also be because the files in [Shared with Me] were not added to the personal Drive!',
      history: false,
      modal: true,
      closeOnEsc: true,
      buttons: [
